...
2. $MENU2 - выполняется резервное копирование настроечных файлов, настройка и сохранение в файлах параметров входа в домен, а также выполнение фдола в домен. 
...
4. $MENU4 - возможность восстановить настроечные файлы в исходное состояние или сделать бекам уже настроенной конфигурации
...
#############################
GetVariables () #Получение переменных из фалов настроек
{
