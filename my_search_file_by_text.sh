...
Если фраза содержит пробелы, необходимо брать её в двойные ковычки \" \"
	$0 --gui /home/user - откроет диалоговое окно, в котором по умолчанию будет выбрана папка поиска /home/user
...
If the phrase contains spaces , you must take it in double quotes \" \"
	$0 --gui /home/user - Opens a dialog box in which is selected by default Search Folder /home/user
